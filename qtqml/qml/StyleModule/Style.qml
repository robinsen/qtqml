...
QtObject {
    ...
    readonly property color backgroundColor: isDarkTheme ? "#131723" : "#FFFFFF"
    readonly property color backgroundColor1: isDarkTheme ? "#060915" : "#FFFFFF"
    readonly property color backgroundColor2: isDarkTheme ? "#222734" : "#FFFFFF"
    ...
    readonly property int titleItemLenth: 80
    readonly property color borderColor: isDarkTheme ? "#3344FF" : "#FFFFFF"
}
